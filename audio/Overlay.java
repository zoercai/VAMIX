				...
				if ((inputVideoField.getText() != null) && (inputAudioField.getText() != null)
					...
					JOptionPane
							.showMessageDialog(null,
									"Overlay not completed. Please specify all files correctly!");
				}
			}
		});
	}
		...
		protected Integer doInBackground() throws Exception {
			...
			if (checkFileProcess.exitValue() == 0) { // file exists already
				...
				if (a == JOptionPane.YES_OPTION) { // override
					String avconvCmd = "avconv -y -i "+inputVideoFile+" -i "+inputAudioFile+" -filter_complex amix=inputs=2 -crf 18 "+outputFile;
