...
/**
 * 
 * Controls the video while it's playing. This is the class responsible for the
 * playback controls such as play and forward. It is responsible for the drawing
 * of the components (buttons) as well as the logic and processes of playback
 * control.
 * 
 * @author zoe
 *
...
public class Playback extends JPanel {
	...
	public Playback(JFrame frame, EmbeddedMediaPlayer videoPlayer,
			Canvas canvas, String videoLocation, TimeBar timebar,
			Effects effects) {
		...
		public void actionPerformed(ActionEvent e) {
			if (_videoLocation == null) {
				JOptionPane.showMessageDialog(_frame,
						"Open a media file by click the Open button");
			} else if (_endOfVideo == true) {
				_endOfVideo = false;
				_paused = false;
				_videoPlayer = new VideoPlayer(_canvas, _videoLocation,
						_timeBar, Playback.this, _effects);
