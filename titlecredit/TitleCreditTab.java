...
public class TitleCreditTab extends JPanel{
	...
	public TitleCreditTab(){
		...
		TitledBorder titleTitle = BorderFactory.createTitledBorder(blackline, "Add Title");
		...
		TitledBorder creditTitle = BorderFactory.createTitledBorder(blackline, "Add Credit");
